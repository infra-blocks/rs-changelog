...
pub struct BlockQuoteBuilder<T>
where
    T: NodeBuilder<Node = BlockQuoteNode>,
{
...
impl<T> BlockQuoteBuilder<T>
where
    T: NodeBuilder<Node = BlockQuoteNode>,
{
    pub fn new<U: Into<location::Span>, V: Into<Vec<Box<T>>>>(location: U, children: V) -> Self {
        Self {
...
impl<T> NodeBuilder for BlockQuoteBuilder<T>
where
    T: NodeBuilder<Node = BlockQuoteNode>,
{
